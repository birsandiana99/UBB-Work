...
public class PrgState {
    ...
    public PrgState(MyIStack<IStmt> stk, MyIDictionary<String, Value> symtbl, MyIList<Value> ot, MyIDictionary<String,BufferedReader> filetbl, MyIHeap<Value> hp, IStmt prg) {
        exeStack = stk;
        symTable = symtbl;
        out = ot;
